...
export const post: Post = {
  slug: "life-story",
  title: "My whole life story in a nutshell",
  date: "2026-07-18",
...
There were 30 computers in our CS lab, hence the school only allowed top 30 students to purse CS who got the highest score in Maths. My rank was 31st.


I remember that day in class, my teacher asked everyone to fill their choices. CS/ Commerce as a subject from class 9th. Almost all my friends opted for CS, one spot was left.
Because one guy was absent that day. My teacher said "let him come back, if he doesn't opt for CS, the seat will go to the nearest candidate, which is Subhro" - I stood up, and I felt the weight. 
I knew I am not getting CS, that was the first taste of rejection in life, knowing how to handle failure and accepting the consequences.

Fast forward to 2021. I passed 12th grade, without a CS degree, 
I did not have a computer in my home, so I used to watch youtube videos of programming in [Python](https://www.youtube.com/watch?v=rfscVS0vtbw) and wrote the code in a diary.


## 2021
I passed one of the college entrance exam tests with flying colors and started pursuing CS from [Academy of Technology](https://en.wikipedia.org/wiki/Academy_of_Technology)

![First year in college, speaking on some random shit](/life_story2.jpg)

## 2022
My journey slowly begins and I started coding, attending hackathons, by the end of 2022 I was the first one to get an internship in my class/whole college. 
A first year kid who did not know how to code untill recently, got an internship, I was proud of myself.
...
Had a great team offsite in London with my team. I explored the streets of London for the first time all by myself, it felt liberating, I felt independent. It was a surreal experience. I went to the King's Cross Station and saw someone playing interstellar in a piano, and I could not capture it in a video, I will regret that. it was so beautiful.


![The booth had spiders in it, haha](/life_story4.jpg)

more in my [instagram](https://www.instagram.com/subhros_story/)


### I had my poster accepted in Pycon USA 2026


![PyCon USA](/lifestory5.JPG)

I visited 5 countries in a span of 5 months, from nothing in 2021 to exploring the world in 2026, it was a long journey, it was a nice journey. 
